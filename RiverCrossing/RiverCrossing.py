while True:
    ...
    options = input("Enter your choice (1 or 2) >>> ")
    if options == "1":
        adultsamt = int(input("How many adults are trying to cross the river >>> "))
        print("Lets go with 2 children.")
        print("------------------------------")
        details = f"{adultsamt} Adults and 2 Children"
        start = input(f"Is this correct: {details}? (y/n) ")
        if start == "y" or "yes":
            ...
            adultsamt = input("How many adults are trying to cross the river >>> ")
            print("Lets go with 2 children.")
            print("------------------------------")
